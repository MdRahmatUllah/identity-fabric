...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Identica — ID Card Generation Platform" },
      { name: "description", content: "Design, manage and generate identity cards at scale with templates, bulk pipelines and audit-ready history." },
      { property: "og:title", content: "Identica — ID Card Generation Platform" },
      { property: "og:description", content: "Generate print-ready identity cards individually or in bulk." },
